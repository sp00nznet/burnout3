...
/**
 * Initial ESP value for recompiled functions.
 * Points to the top of the Xbox stack area in mapped memory.
 * Each translated function initializes its local esp from this.
 */
extern uint32_t g_xbox_initial_esp;
